...
def sensor_value(device):
    ...
    token = "Token {TOKEN}".format(TOKEN="1677929ef551e0b4369eebc61b8c54ec4adcafea")
    ...
    for i in category:
        if i == 'datetime':
            new_data[f'{i}'] = [content['data']['Logger Temperature'][0]['readings'][x][f'{i}'][:-9] for x in range(per_page)]
...
def main():
    ...
    device_list = ['z6-20051', 'z6-20054', 'z6-20055', 'z6-20058', 'z6-20060', 'z6-20062', 'z6-20063']
